    ...
    <main className="flex-1 bg-gray-100 p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <div key={index} className="bg-white shadow rounded-lg p-6 transition duration-300 ease-in-out transform hover:bg-blue-100 hover:-translate-y-1">
            <div className="flex items-center mb-4">
              <FontAwesomeIcon icon={item.icon} className="text-blue-500 mr-2 transition duration-300 ease-in-out transform hover:text-blue-700" />
              <h3 className="text-lg font-semibold mb-2 text-gray-900 transition duration-300 ease-in-out transform hover:text-blue-700">{item.title}</h3>
            </div>
